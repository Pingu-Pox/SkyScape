...
Event OnHit(ObjectReference akAggressor, Form akSource, Projectile akProjectile, bool abPowerAttack, bool abSneakAttack, bool abBashAttack, bool abHitBlocked)
	If akAggressor == Game.GetPlayer() && RS_FormList_Pickaxes.HasForm(akSource)
		...
		if ((rsFrameworkMenu.GetMiningLVL()).GetValue()) < reqLVL
			...
			int addCount = 1
			rsFrameworkMenu.HarvestItemOnce(RS_GV_Skill_Mcounter, self, RS_Rock_Depleted, 1, oreType, akSourceWeapon, RS_SM_HarvestOre, none, self, respawnInterval, addCount, true, "mining", finalGainedXP, self)
		endif
	Endif
EndEvent
